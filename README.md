...
The project includes two persistence units in the persistence.xml file: one for Hibernate and one for OpenJPA. To test either or, please have a look at the main class in lazyjpatest.LazyJPATest.java (constructor). Replace the persistence unit with the one to be tested against.
